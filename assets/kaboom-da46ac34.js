...
var Nt = (i, t, l) => t in i ? jt(i, t, { enumerable: true, configurable: true, writable: true, value: l }) : i[t] = l, P = (i, t) => {
  for (var l in t || (t = {}))
  ...
  return i;
}, D = (i, t) => Ki(i, Hi(t)), a = (i, t) => jt(i, "name", { value: t, configurable: true });
var Qi = (i, t) => {
  for (var l in t)
...
var qr = { ArrowLeft: "left", ArrowRight: "right", ArrowUp: "up", ArrowDown: "down", " ": "space" }, Pr = ["left", "middle", "right", "back", "forward"], ds = ["space", "left", "right", "up", "down", "tab", "f1", "f2", "f3", "f4", "f5", "f6", "f7", "f8", "f9", "f10", "f11", "s"], Dr = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~", fs = " ☺☻♥♦♣♠•◘○◙♂♀♪♫☼►◄↕‼¶§▬↨↑↓→←∟↔▲▼ !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~⌂ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜ¢£¥₧ƒáíóúñÑªº¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■", Ar = 0, Or = 3, ps = 0, ms = 3, ws = -1200, gs = 1200, je = "topleft", Ir = 1600, bt = 65536, Vr = 64, Us = "apl386o", on = "sink", Ye = 9, ys = `
...
`, xs = /* @__PURE__ */ new Set(["id", "require"]), vs = /* @__PURE__ */ new Set(["add", "load", "update", "draw", "destroy", "inspect"]);
function kr(i) {
...
var ao = a((i = {}) => {
  let t = (() => {
    ...
    var d, h;
    let e = t.gl, n = hn(an, un), r = He(new ImageData(new Uint8ClampedArray([255, 255, 255, 255]), 1, 1));
    (d = i.background) != null ? d : E(0, 0, 0);
    if (i.background) {
...
` && (M.push(oe), y += m, oe === " " && (ee = M.length)), W = Math.max(W, y), te++;
  ...
  function bn() {
    let e = t.gl, n = e.drawingBufferWidth, r = e.drawingBufferHeight;
    if (Tn()) {
